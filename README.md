...
4. RPC URL for `Polygon zkEVM Mainnet`. We recommend running a full geth/equivalent node to save costs and to stick to ethos of decentralization! :)
> It's highly recommended to signup with one of these providers to at least track usage even if you aren't on a paid plan: [Alchemy](https://alchemy.com/?r=15ce6db6d0a109d5), [Ankr](https://www.ankr.com/rpc/polygon_zkevm), [Quicknode](https://www.quicknode.com?tap_a=67226-09396e&tap_s=3491854-f4a458), etc. Please reach out to us if none of the options are viable.
...
2. Copy `env.example` to `.env`.
   - Ensure the following required variables are filled:
     - `SOURCE_RPC_URL`: The URL for Polygon `zkEVM Mainnet RPC` (Local node/Quicknode/Alchemy) service.
